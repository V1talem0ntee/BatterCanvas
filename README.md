[![Review Assignment Due Date](https://classroom.github.com/assets/deadline-readme-button-22041afd0340ce965d47ae6ef1cefeee28c7c493a6346c4f15d667ab976d596c.svg)](https://classroom.github.com/a/VvX-fwym)
...
Replace your GitHub username in the repository name with your **team alias** and **team number**.

Example:

If your repository is initially named `csc648-848-su26-project-jortizco`, your team alias is `StackOverflowSurvivors`, and team number is `5`, then rename it to:

`csc648-848-su26-project-stackoverflowsurvivors-05`
...
|:------:|:---------:|:----------:|:---------------:|:----------------:|:------:|:---------------:|
| #1 | Wen Chien Yen | wyen@sfsu.edu | JeffYen1 | jeff0221 | Team Lead / Scrum Master | Yes |
| #2 | Oscar Wang | owang1@sfsu.edu | CrunchiesJL | crunchies | Frontend Lead / Technical Writer | Yes |
| #3 | Banghao Yuan |Byuan1@sfsu.edu |V1talem0ntee |.ergou |Software Architect | Yes |
| #4 | Sean Wang | swang29@sfsu.edu | sw8ng | seanyhwang | Database Administrator | Yes |
| #5 | Enoch Lin | elin5@sfsu.edu | enochlin8 | e_bok | Github Master | Yes |
| #6 | Kashif Zada| kzada@sfsu.edu | Kashifzada | kashi77 | Backend Lead | Yes |
| #7 | | | | | | No |
...
|:----------:|:-------------|:------------|:----------------------:|
| BigBacks | Better Student Center | http://18.226.97.234/ | Consensus or Majority |
